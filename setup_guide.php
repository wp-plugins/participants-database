...
<h1>Participants Database Quick Setup Guide</h1>
<h2>Initial Setup</h2>
...
<p>Meanwhile, the site admin receives an email notifying them of the signup, and provides them with a direct link to the new record.</p>
<h2>Here&#8217;s How We Set That Up</h2>
<ol>
...
<p>When someone visits the site, you can show them a list of all the people who have signed up. Each name on the list can be clicked to take the user to a detail page showing all the public information in their record. This is how to set that up.</p>
<ol>
<li>Place the &#8220;&#91;pdb_list]&#8221; shortcode on the page where you want the list of participants to go.</li>
<li>On the &#8220;Manage Database Fields&#8221; page you can determine which columns (or fields) get shown in the list. This is under the &#8220;Display&#8221; column and you give each field you want to show a number depending on what order you want them to appear in. Zero means it won&#8217;t show at all.</li>
<li>On the page where you want the record detail to show, place the &#8220;&#91;pdb_single]&#8221; shortcode. This page won&#8217;t show anything unless it is visited using a link with the ID of the record to show in it.</li>
