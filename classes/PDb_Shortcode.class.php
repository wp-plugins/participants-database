...
abstract class PDb_Shortcode {
  ...
  public function the_group() {
    ...
    $this->group = new Field_Group( call_user_func( $function, &$this->record ), $this->module );
  ...
  public function the_field() {
    ...
    $this->field = is_object( $this->group ) ?
      new Field( call_user_func( $function, &$this->group->fields ) ) :
      new Field( call_user_func( $function, &$this->record->fields ), $this->record->record_id );
  ...
  public function have_records() {
		...
		return $this->current_record_pointer <= $this->shortcode_atts['list_limit'] ;
  ...
  protected function _set_field_value( &$field ) {
    ...
    // get the existing value if any
		...
		if ( isset( $_POST[ $field->name ] ) ) {
			...
			$value = esc_html( stripslashes( $_POST[ $field->name ]) );
