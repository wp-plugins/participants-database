...
<div class="wrap">
	<div id="poststuff">
		<div id="post-body">
			<h2><?php echo Participants_Db::$plugin_title.' '.__('Import CSV File', 'participants-database' )?></h2>
			...
			<input type="hidden" name="CSV type" value="blank" />
				<div class="postbox">
					<h3><?php _e('1. Prepare a spreadsheet file with the correct format:', 'participants-database' )?></h3>
					<div class="inside">
			...
			<div class="postbox">
				<h3><?php _e( '2. Upload the .csv file', 'participants-database' )?></h3>
				<div class="inside">
            ...
            <p><?php _e( 'Exported CSV files should be comma-delimited and enclosed with double-quotes ("). Encoding should be "UTF-8."', 'participants-database' )?></p>
